...
- **Adding an SVG icon** - `docs/assets.md` covers usage but not how to add a new icon to `packages/core/svg-icons/`.
...
- **rsc-ssr.md**: no guidance on when to create a `.browser` file vs keep server-only. The decision rule is implicit.
