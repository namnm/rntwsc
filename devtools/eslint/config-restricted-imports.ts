const message = 'Use `rntwsc/tw` instead'
...
export const restrictedImports = [
  ...
  },
  {
    ...
    importNames: ['cache'],
    message:
      'React cache only works correctly in rsc component tree, in realistic we also need to cover ssr client bundle component tree, please use `rntwsc/cache` instead',
  },
  {
    name: 'react-native',
    importNames: [
