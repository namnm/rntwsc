...
import { mapKeys, mapValues } from 'rntwsc/libs/lodash'
import type { StrMap } from 'rntwsc/libs/utility-types'

// we name it ts-loader to let nextjs not complain about its builtin
const babelLoaderPath = require.resolve('rntwsc/devtools/next-config/ts-loader.js')
const svgLoaderPath = require.resolve('rntwsc/devtools/next-config/svg-loader.js')
