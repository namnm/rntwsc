...
import type {
  ...
  SelectItem,
  SelectProps,
} from 'rntwsc/components/select/select-cva'
import { selectCva } from 'rntwsc/components/select/select-cva'
import { Span } from 'rntwsc/components/text'
import { Check } from 'rntwsc/icons/check'
import { ChevronBottom } from 'rntwsc/icons/chevron-bottom'
...
const matchItem = (
  ...
  if (s.has('value')) {
    ...
    valueS.delete('value')
    return matchLabel(item.value, query, valueS) ? [] : null
  }
  return null
}
...
export const Select = ({
  ...
  const filteredItems = useMemo(() => {
    ...
    return resolvedItems.filter(i => matchItem(i, query, strategySet))
