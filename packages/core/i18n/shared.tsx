...
// shared by index.native.tsx and index.web.tsx - see i18n.md Internals
...
// returns the resolved lang so callers like native's RTL forcing can use
// it without re-reading storage
export const initI18nShared = async () => {
