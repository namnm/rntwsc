...
import { buildOperationDocument } from 'rntwsc/graphql/codegen/dynamic'
import type {
  SelectedShape,
  Selection,
  Selector,
} from 'rntwsc/graphql/codegen/selector'
import { selectFields } from 'rntwsc/graphql/codegen/selector'
