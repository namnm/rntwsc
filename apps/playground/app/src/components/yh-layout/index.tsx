...
import { rYhCamera, rYhHome, rYhVaccine } from '#/pages/route-paths'
...
export const YhLayout = ({
  ...
  const [fixedContacts, setFixedContacts] = useState<EmergencyContact[]>([
    {
      id: 'f1',
      name: 'Cấp cứu',
      phone: '115',
  ...
  return (
    <NavLayout>
      <View className='relative flex-1 flex-col overflow-hidden bg-white'>
        {/* App Header */}
        {!hideHeader && (
            ...
            <View className='ml-auto flex-row items-start gap-3.5'>
              ...
              <View className='items-center gap-0.5'>
                <View className='relative h-6 w-6 items-center justify-center'>
                  ...
                  <View className='absolute -right-0.5 -bottom-0.5 h-3 w-3 items-center justify-center rounded-full border border-white bg-red-500'>
              ...
              <View className='items-center gap-0.5'>
                <View className='relative h-6 w-6 items-center justify-center rounded-full bg-gray-100'>
                  ...
                  <View className='absolute -top-0.5 -right-0.5 h-3.5 w-3.5 items-center justify-center rounded-full bg-red-500'>
          ...
          {!showChat && !hideFloating && (
            ...
            >
              ...
              <Pressable
                ...
                className='absolute -top-1 -right-1 h-4 w-4 items-center justify-center rounded-full bg-gray-500'
              >
                <svg
                  width='7'
                  height='7'
        ...
        {/* Bottom Tab Bar */}
        <View className='flex-row border-t border-gray-100 bg-white pt-1 pb-4'>
          {tabs.map(tab => {
        ...
        {/* Chat modal — covers content area and tab bar, starts below header */}
        {showChat && (
          <View
            className='absolute right-0 bottom-0 left-0 z-60 flex-col overflow-hidden bg-white'
            style={{
              top: hideHeader ? 0 : 52,
            }}
          >
            ...
            <Pressable
              ...
              className='absolute top-3 right-3 z-10 h-7 w-7 items-center justify-center rounded-full bg-gray-100'
            >
              <svg
                width='11'
                height='11'
            ...
            <ScrollView className='flex-1'>
              ...
              <View
                className='mx-3 rounded-2xl px-3 py-6'
                style={{
              ...
              >
                {/* Title row */}
                <View
                  className='mb-0.5 flex-row items-center justify-center'
                  style={{
                    gap: 6,
                  }}
                >
                ...
                <Span className='mb-3 pl-3 text-[10px] text-gray-500'>
            ...
            <View className='relative border-t border-gray-100 bg-white px-3 py-2 pb-6'>
              {showMoreMenu && (
                <View
                  className='absolute bottom-14 left-3 z-10 overflow-hidden rounded-2xl bg-white shadow-lg'
                  style={{
                    borderWidth: 1,
                    borderColor: '#f0f0f0',
                  }}
              ...
              <View className='flex-row items-center'>
                ...
                <View
                  className='mx-1 flex-1 flex-row items-center rounded-full border border-gray-200 bg-slate-50 pr-2 pl-3'
                  style={{
                    marginLeft: 4,
                  }}
                >
            ...
            {callTarget && (
              <View
                className='absolute right-0 left-0 z-20 items-center justify-center px-6'
                style={{
                  top: 40,
                  bottom: 40,
              ...
              >
                <View className='w-full flex-1 items-center justify-between rounded-3xl bg-white px-6 py-10'>
                  ...
                  {/* Bottom action */}
                  <View className='items-center'>
                    <Span className='mb-5 text-center text-xs text-red-500'>
                      Bạn có chắc chắn gọi khẩn cấp không?
                    </Span>
                    <Pressable
