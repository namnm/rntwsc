...
| Components     | Accordion, Alert, Badge, Button, Checkbox, DatePicker, Drawer, Dropdown, Form, Modal, Radio, Select, Switch, and more - see [components.md](https://github.com/namnm/rntwsc/blob/master/docs/components.md) |
...
See [getting-started.md](https://github.com/namnm/rntwsc/blob/master/docs/getting-started.md) for the full walkthrough, or [existing-app.md](https://github.com/namnm/rntwsc/blob/master/docs/existing-app.md) to add rntwsc into an app you already have.

## Docs

- [Getting started](https://github.com/namnm/rntwsc/blob/master/docs/getting-started.md)
- [Adding rntwsc to an existing app](https://github.com/namnm/rntwsc/blob/master/docs/existing-app.md)
- [Components: built-in component library](https://github.com/namnm/rntwsc/blob/master/docs/components.md)
- [Tailwind: class names, cva, selectors, extras](https://github.com/namnm/rntwsc/blob/master/docs/tailwind.md)
- [Browser variant: resolver level browser resolution](https://github.com/namnm/rntwsc/blob/master/docs/browser-variant.md)
- [Async components: server to sync transpilation](https://github.com/namnm/rntwsc/blob/master/docs/async-components.md)
- [Hydration: fetch and graphql, client nav, refetch](https://github.com/namnm/rntwsc/blob/master/docs/hydration.md)
- [Navigation: routes, Link, useRoute](https://github.com/namnm/rntwsc/blob/master/docs/navigation.md)
- [Theme: built-in themes, custom theme](https://github.com/namnm/rntwsc/blob/master/docs/theme.md)
- [Dark mode: built-in dark mode support](https://github.com/namnm/rntwsc/blob/master/docs/dark-mode.md)
- [I18n: usage, namespaces, languages, switcher](https://github.com/namnm/rntwsc/blob/master/docs/i18n.md)
- [Image, SVG, HTML semantics](https://github.com/namnm/rntwsc/blob/master/docs/assets.md)

## Contributing

See [docs/contribution](https://github.com/namnm/rntwsc/blob/master/docs/contribution/README.md) for the internal architecture, build process, and dev workflow.
